...
@push('styles')
    <style>
        /* --------- Variables de color --------- */
        :root {
            --primary-1: #4e54c8; /* morado oscuro  */
            --primary-2: #8f94fb; /* morado claro   */
            --white: #ffffff;
            --grey-light: #f5f7fa;
            --grey-text: #6c757d;
            --danger: #dc3545;
        ...
        * {
        ...
        .input:focus {
            ...
            box-shadow: 0 0 0 .25rem rgba(78, 84, 200, .25);
        }
        ...
        .card__header {
            text-align: center;
            padding: 3.5rem 2rem 2rem; /* espacio arriba para que no toque el borde */
        }

        .logo { /* limita tamaño y lo centra */
            width: 90px;
            height: auto;
            display: block; /* bloque para que funcione el margin auto */
...
@section('content')
    <section class="card">
        ...
        <header class="card__header">
            <svg class="logo" viewBox="0 -70 370 250" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g xmlns="http://www.w3.org/2000/svg" id="g8" transform="matrix(1.3333333,0,0,-1.3333333,0,199.58267)">
                    <g id="g10" transform="translate(308.4697,124.1287)">
                        <path
                            d="m 0,0 h 3.618 l 16.025,-38.195 h 0.115 L 35.61,0 h 3.619 V -41.01 H 36.701 V -3.101 H 36.587 L 20.964,-41.01 H 18.437 L 2.642,-3.101 H 2.526 V -41.01 H 0 Z"
