<div class="max-w-4xl mx-auto p-6 space-y-8 container-full">
            ...
            <div class="mt-6">
                ...
                <div x-show="activeTab === 'sin-categoria'">
                    ...
                    <div x-data class="relative">
                        <div
                            class="flex overflow-x-auto py-2  gap-[10px]"
                            x-ref="slider">
                            @foreach($cardsWithoutCategory as $card)
                            <div
    wire:click="toggleCard({{ $card->id }})"
    class="group md:w-1/3 w-full  rounded-[15px] shadow-none transition-all duration-300 ease-in flex-shrink-0 p-10 border rounded shadow cursor-pointer hover:bg-[#195b81] hover:text-[#ffffff]  
        {{ in_array($card->id, $selectedCards) ? 'border-[#56dee5] border-[5px] bg-[#195b81] text-[#ffffff]' : 'bg-white' }}">
    
    <img 
        class="w-[35px] mb-[15px] invert transition-all duration-300
            {{ in_array($card->id, $selectedCards) ? 'brightness-[0]' : 'brightness-75 group-hover:brightness-[0]' }}" 
    ...
    <h2 class="font-bold text-lg">{{ $card->pregunta }}</h2>
                ...
                <div x-show="activeTab === 'cat-{{ $cat->id }}'">
                    ...
                    <div x-data class="relative">
                        <div class="flex gap-[10px]  overflow-x-auto py-2 " x-ref="slider">
                            @foreach($cardsInCategory as $card)
                            <div
                                wire:click="toggleCard({{ $card->id }})"
                                class="group  md:w-1/3 w-full rounded-[15px] shadow-none transition-all duration-300 ease-in  flex-shrink-0 p-10 border rounded shadow cursor-pointer hover:bg-[#195b81] hover:text-[#ffffff]  
                                        {{ in_array($card->id, $selectedCards) ? '  border-[#56dee5] border-[5px] bg-[#195b81] text-[#ffffff]' : 'bg-white' }}">
                                <img class="w-[35px] mb-[15px] invert transition-all duration-300
            {{ in_array($card->id, $selectedCards) ? 'brightness-[0]' : 'brightness-75 group-hover:brightness-[0]' }}" src="data:image/svg+xml;base64," />
                                <h2 class="font-bold text-lg">{{ $card->pregunta }}</h2>
                            </div>
                            @endforeach
                        </div>
