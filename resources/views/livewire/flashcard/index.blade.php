<div class="max-w-4xl mx-auto p-6 space-y-8 container-full">
            ...
            <div class="mb-4 relative">
                <div class="flex justify-between">
                    ...
                    <button
                        ...
                        class="relative h-10 flex bg-[#195b81] transition duration-300 hover:bg-[#0d4362] px-[20px] py-[3px] rounded-[8px] justify-center items-center gap-[8px] text-white font-semibold text-[12px]">
                        <img class="w-[22px]"
    ...
    <div class="bg-white max-w-full border-none shadow-none p-[40px] rounded-[20px] mb-10">
        ...
        <div class="flex items-center justify-between mb-2">
            ...
            <div class="relative inline-block">
                <button type="button"
                    ...
                    class="relative flex md:w-auto w-full  md:mb-0 items-center justify-center gap-2 transition duration-300 rounded-[8px] text-[15px] font-medium px-[25px] py-[10px] text-white
        ...
        <!-- Tabs -->
        <div class="border-b box-cat-flash mt-5">
