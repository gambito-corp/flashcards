            ...
            <div class=" rounded-lg  p-6">
                ...
                <div class="relative perspective-1000 w-full "
                    ...
                    <div class="w-full  transition-transform duration-500 transform-style-3d"
                        ...
                        <div class=" w-full  backface-hidden bg-white p-4 border rounded shadow flex  justify-center box-answer flex-col">
                            ...
                            <img class="img-answer" src="{{ asset('img.png') }}" alt="Imagen">
                        </div>
                        <!-- Cara trasera (respuesta) -->
                        <div class="absolute w-full h-full backface-hidden bg-white p-4 rounded  flex  justify-center transform rotate-y-180 answer-c flex-col top-0">
                        <div class="box-content-answer">
                ...
                <div class="mt-6">
                    ...
                    <div x-show="!showAnswer">
                        <button wire:click="revealAnswer"
                                ...
                                class=" py-2 px-4 bg-blue-600 text-white rounded hover:bg-blue-700 transition duration-200 boton-success-m">
                            Revelar Respuesta
                        </button>
                    </div>
