<div class="max-w-xl mx-auto bg-white p-6 rounded-lg shadow-lg border border-gray-200 container-ask">
    <h1 class="text-2xl font-bold mb-4 primary-color title-ask-container">Editar Parametro de Configuracion: {{$config->tipo}}</h1>
    ...
    <form wire:submit.prevent="update" class="form-container-ask">
        <div class="mb-4">
            ...
            />
            @error('config.value') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
        </div>
