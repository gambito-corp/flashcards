<div class="max-w-5xl mx-auto bg-white p-6 rounded-lg shadow-lg border border-gray-200 container-ask">
    ...
    <form wire:submit.prevent="updateQuestion" class="form-container-ask">
        ...
        <div class="mb-4">
            ...
            <textarea wire:model.live="newContent" id="newContent" rows="4" class="mt-1 block w-full border-gray-300 rounded px-3 py-2 focus:outline-none focus:border-[#195b81] focus:ring-[#195b81] " placeholder="Escribe el enunciado..."></textarea>
        ...
        <div class="mb-4 form-ct">
            ...
            <div class="mb-2">
                ...
                <select wire:model.live="selectedTeam" id="team" class="w-full border-gray-300 rounded px-3 py-2 focus:outline-none focus:border-[#195b81] focus:ring-[#195b81] ">
            ...
            <div class="mb-2">
                ...
                <select wire:model.live="selectedArea" id="area" class="w-full border-gray-300 rounded px-3 py-2 focus:outline-none focus:border-[#195b81] focus:ring-[#195b81] ">
            ...
            <div class="mb-2">
                ...
                <select wire:model.live="selectedCategory" id="category" class="w-full border-gray-300 rounded px-3 py-2 focus:outline-none focus:border-[#195b81] focus:ring-[#195b81] ">
            ...
            <div class="mb-2">
                ...
                <select wire:model.live="selectedTipo" id="tipo" multiple class="w-full border-gray-300 rounded px-3 py-2 focus:outline-none focus:border-[#195b81] focus:ring-[#195b81] ">
        ...
        <div class="mb-4 form-ct">
            ...
            <input type="text" wire:model.live="newMediaUrl" id="newMediaUrl" class="mt-1 block w-full border-gray-300 rounded px-3 py-2 focus:outline-none focus:border-[#195b81] focus:ring-[#195b81] " placeholder="Ingresa la URL de YouTube">
        ...
        <div class="mb-4 ">
            ...
            <textarea wire:model.live="newMediaIframe" id="newMediaIframe" rows="3" class="mt-1 block w-full border-gray-300 rounded px-3 py-2 focus:outline-none focus:border-[#195b81] focus:ring-[#195b81] " placeholder="Ingresa el iframe aquí..."></textarea>
