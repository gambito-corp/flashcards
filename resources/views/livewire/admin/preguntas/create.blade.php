<div class="max-w-5xl mx-auto bg-white p-6 rounded-lg shadow-lg border border-gray-200 container-ask">
    <h1 class="text-2xl font-bold mb-4 primary-color title-ask-container">Crear Nueva Pregunta</h1>
    <hr>
    ...
    <form wire:submit.prevent="store"  class="form-container-ask">
        ...
        <div class="mb-4">
            ...
            <textarea wire:model="newContent" id="newContent" rows="4" class="mt-1 block w-full border-gray-300 rounded px-3 py-2 focus:outline-none focus:border-[#195b81] focus:ring-[#195b81] " placeholder="Escribe el enunciado..."></textarea>
  ...
  <div class="mb-2">
                ...
                <select wire:model="selectedTeam" id="team" class="w-full border-gray-300 rounded px-3 py-2 focus:outline-none focus:border-[#195b81] focus:ring-[#195b81] ">
 ...
 <div class="mb-2">
                ...
                <select wire:model="selectedArea" id="area" class="w-full border-gray-300 rounded px-3 py-2 focus:outline-none focus:border-[#195b81] focus:ring-[#195b81] ">
            ...
            <div class="mb-2">
                ...
                <select wire:model="selectedCategory" id="category" class="w-full border-gray-300 rounded px-3 py-2 focus:outline-none focus:border-[#195b81] focus:ring-[#195b81] ">
            ...
            <div class="mb-2">
                ...
                <select wire:model="selectedTipo" id="tipo" multiple class="w-full border-gray-300 rounded px-3 py-2 focus:outline-none focus:border-[#195b81] focus:ring-[#195b81] ">
            ...
            <div class="mt-1 flex flex-wrap gap-8">
                @foreach($universidades as $universidad)
                    <label class="flex items-center">
                        <input type="checkbox" wire:model="selectedUniversidades" value="{{ $universidad->id }}" class="mr-2 checkbox-form">
        ...
        <!-- Campos para Media -->
        <div class="mb-4 form-ct div">
            <label for="newMediaUrl" class="block text-sm font-medium text-gray-700">URL de YouTube:</label>
            <input type="text" wire:model="newMediaUrl" id="newMediaUrl" class="mt-1 block w-full border-gray-300 rounded px-3 py-2 focus:outline-none focus:border-[#195b81] focus:ring-[#195b81] " placeholder="Ingresa la URL de YouTube">
        ...
        <div class="mb-4 form-ct div">
            ...
            <textarea wire:model="newMediaIframe" id="newMediaIframe" rows="3" class="mt-1 block w-full border-gray-300 rounded px-3 py-2 focus:outline-none focus:border-[#195b81] focus:ring-[#195b81] " placeholder="Ingresa el iframe aquí..."></textarea>
        ...
        <div class="mb-4 form-ct div">
            ...
            <textarea wire:model="newExplanation" id="newExplanation" rows="3" class="mt-1 block w-full border-gray-300 rounded px-3 py-2 focus:outline-none focus:border-[#195b81] focus:ring-[#195b81] " placeholder="Explica la respuesta correcta (si aplica)..."></textarea>
            ...
            <div class="mb-4 form-ct div ">
                ...
                @foreach($newOptions as $index => $answer)
                    <div class="flex items-center mb-2">
                        <input type="radio" wire:model="newCorrectOption" value="{{ $index }}" class="mr-2" title="Marca la opción correcta checkbox-form ">
                        <input type="text" wire:model="newOptions.{{ $index }}" class="flex-1 border rounded px-3 py-2 focus:outline-none focus:border-[#195b81] focus:ring-[#195b81] " placeholder="Opción {{ $index + 1 }}">
        ...
        <div class="flex  space-x-4 mt-4">
            ...
            <button type="button" wire:click="store" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded boton-success-m">
                Guardar Pregunta
            </button>
        </div>
    </form>
