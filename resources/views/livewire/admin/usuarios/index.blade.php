                ...
                @foreach($data as $item)
                    <tr class="border-b last:border-0">
                        ...
                        <td class="px-4 py-2 text-center">
                            @if($this->getUserStatus($item->status) === 'Premium')
                                <i class="fa-solid fa-star text-yellow-500" title="Usuario Premium"></i>
                            @else
                                <i class="fa-solid fa-user text-blue-500" title="Usuario Regular"></i>
                            @endif
                        </td>
                        ...
                        <td class="px-4 py-2">
                            @if ($item->profile_photo_path)
                                <img
                                    src="{{ Storage::disk('s3')->temporaryUrl($item->profile_photo_path, now()->addMinutes(10)) }}"
                                    alt="Foto de Perfil" class="w-10 h-10 rounded-full">
                            @else
                                <img src="{{ $item->profile_photo_url }}" alt="Foto de Perfil"
