<div class="max-w-xl mx-auto bg-white p-6 rounded-lg shadow-lg border border-gray-200 container-ask">
    ...
    <form wire:submit.prevent="store" class="form-container-ask">
        ...
        <div class="mb-4">
            ...
            <select id="team" wire:model.live   ="selectedTeam" class="w-full border rounded px-3 py-2 focus:outline-none focus:border-[#195b81] focus:ring-[#195b81] ">
        ...
        <div class="mb-4">
            ...
            <select id="area" wire:model.live   ="selectedArea" class="w-full border rounded px-3 py-2 focus:outline-none focus:border-[#195b81] focus:ring-[#195b81] ">
        ...
        <div class="mb-4">
            ...
            <select id="category_id" wire:model.live    ="tipo.category_id" class="w-full border rounded px-3 py-2 focus:outline-none focus:border-[#195b81] focus:ring-[#195b81] ">
