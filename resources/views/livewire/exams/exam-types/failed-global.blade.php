<div class="mb-8">
    ...
    <div class="bg-white p-6 rounded container-askt mb-8">
        ...
        <div class="carousel-container overflow-x-auto mb-5 relative">
            ...
            <button
                class="prev absolute left-0 top-1/2 transform -translate-y-1/2 bg-gray-600 text-white p-2 rounded-full">
                <i class="fas fa-chevron-left"></i>
            </button>
            <button
                class="next absolute right-0 top-1/2 transform -translate-y-1/2 bg-gray-600 text-white p-2 rounded-full">
        ...
        @if($areas->count() === 0)
            <div class="text-center text-gray-500 py-8">
                No hay áreas con preguntas falladas disponibles.
            </div>
        @endif
        @if(count($categories) > 0)
        ...
        @if(count($categories) > 0)
            ...
            <div class="mt-4 form-container-ask">
                ...
                <input type="number"
                       ...
                       min="1"
                       max="{{ $maxQuestions }}"
                       class="mt-1 block w-full rounded  focus:border-[#195b81] focus:ring-[#195b81]  border-gray-300"
    ...
    <div class="bg-white p-6 rounded container-askt">
        ...
        <form action="{{route('examenes.failed-global')}}" method="POST">
            @csrf
            @method('POST')
